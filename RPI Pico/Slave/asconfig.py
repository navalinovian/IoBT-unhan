...
config_v1 = RadioSetup(SPI(0, sck=Pin(2), mosi=Pin(3), miso=Pin(4)), Pin(5), Pin(6), True)  # V1 Micropower PCB
config_v2 = RadioSetup(SPI(0, sck=Pin(2), mosi=Pin(3), miso=Pin(4)), Pin(5), Pin(6), True)  # V2 Micropower PCB with SD card
